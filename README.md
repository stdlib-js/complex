...
```javascript
import { Complex128, Complex64, base, complex, complexCtors, complexDataType, complexDataTypes, complexPromotionRules, conj, conjf, equalComplex128, imag, imagf, real, realf, reim, reimf, reviveComplex, reviveComplex128, reviveComplex64 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex@deno/mod.js';
```
