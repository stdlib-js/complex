...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex@v0.4.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { base, complex, ctors, dtype, dtypes, float32, float64, promotionRules, reviveComplex } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex@v0.4.1-esm/index.mjs';
```
