...
*/
setReadOnly( ns, 'isAlmostEqual', require( './../../../../float64/base/assert/is-almost-equal' ) );
...
*/
setReadOnly( ns, 'isAlmostSameValue', require( './../../../../float64/base/assert/is-almost-same-value' ) );
...
*/
setReadOnly( ns, 'isEqual', require( './../../../../float64/base/assert/is-equal' ) );
...
*/
setReadOnly( ns, 'isNotEqual', require( './../../../../float64/base/assert/is-not-equal' ) );
