...
*/
setReadOnly( ns, 'isAlmostSameValue', require( './../../../../float32/base/assert/is-almost-same-value' ) );
...
*/
setReadOnly( ns, 'isEqual', require( './../../../../float32/base/assert/is-equal' ) );
...
*/
setReadOnly( ns, 'isNotEqual', require( './../../../../float32/base/assert/is-not-equal' ) );
